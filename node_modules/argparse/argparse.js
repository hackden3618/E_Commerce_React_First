 ...
 *     args.log.close()
 *
 * The module contains the following public classNamees:
 *
 ...
 *
 *     - Action -- The base className for parser actions. Typically actions are
 *         selected by passing strings like 'store_true' or 'append_const' to
 *         the action= argument of add_argument(). However, for greater
 *         customization of ArgumentParser actions, subclassNamees of Action may
 *         be defined and passed as the action= argument.
 *
 *     - HelpFormatter, RawDescriptionHelpFormatter, RawTextHelpFormatter,
 *         ArgumentDefaultsHelpFormatter -- Formatter classNamees which
 ...
 *         to the help.
 *
 * All other classNamees in this module are considered implementation details.
...
// decorator that allows a className to be called without new
function _callable(cls) {
    let result = { // object is needed for inferred className name
        [cls.name]: function (...args) {
            let this_className = new.target === result || !new.target
            return Reflect.construct(cls, args, this_className ? cls : new.target)
        }
    }
...
// decorator that allows snake_case className methods to be called with camelCase and vice versa
function _camelcase_alias(_className) {
    for (let name of Object.getOwnPropertyNames(_className.prototype)) {
        let camelcase = name.replace(/\w_[a-z]/g, s => s[0] + s[2].toUpperCase())
        if (camelcase !== name) _alias(_className.prototype, camelcase, name)
    }
    return _className
}
...
// =============================
// Utility functions and classNamees
// =============================
function _AttributeHolder(cls = Object) {
    /*
     *  Abstract base className that provides __repr__.
     *
     *  The __repr__ method returns a string in the format::
     *      classNameName(attr=name, attr=name, ...)
     *  The attributes are determined either by a className-level attribute,
     *  '_kwarg_names', or by inspecting the instance __dict__.
     */

    return className _AttributeHolder extends cls {
        [util.inspect.custom]() {
...
// Formatting Help
// ===============
const HelpFormatter = _camelcase_alias(_callable(className HelpFormatter {
    /*
     *  Formatter for generating usage messages and argument help strings.
     *
     *  Only the name of this className is considered a public API. All the methods
     *  provided by the className are considered an implementation detail.
     */
...
HelpFormatter.prototype._Section = _callable(className _Section {
...
const RawDescriptionHelpFormatter = _camelcase_alias(_callable(className RawDescriptionHelpFormatter extends HelpFormatter {
    /*
...
const RawTextHelpFormatter = _camelcase_alias(_callable(className RawTextHelpFormatter extends RawDescriptionHelpFormatter {
    /*
...
const ArgumentDefaultsHelpFormatter = _camelcase_alias(_callable(className ArgumentDefaultsHelpFormatter extends HelpFormatter {
    /*
...
const MetavarTypeHelpFormatter = _camelcase_alias(_callable(className MetavarTypeHelpFormatter extends HelpFormatter {
    /*
...
const ArgumentError = _callable(className ArgumentError extends Error {
    /*
...
const ArgumentTypeError = _callable(className ArgumentTypeError extends Error {
    /*
...
// Action classNamees
// ==============
const Action = _camelcase_alias(_callable(className Action extends _AttributeHolder(Function) {
    /*
    ...
    constructor() {
        ...
        // when this className is called as a function, redirect it to .call() method of itself
...
const BooleanOptionalAction = _camelcase_alias(_callable(className BooleanOptionalAction extends Action {
...
const _StoreAction = _callable(className _StoreAction extends Action {
...
const _StoreConstAction = _callable(className _StoreConstAction extends Action {
...
const _StoreTrueAction = _callable(className _StoreTrueAction extends _StoreConstAction {
...
const _StoreFalseAction = _callable(className _StoreFalseAction extends _StoreConstAction {
...
const _AppendAction = _callable(className _AppendAction extends Action {
...
const _AppendConstAction = _callable(className _AppendConstAction extends Action {
...
const _CountAction = _callable(className _CountAction extends Action {
...
const _HelpAction = _callable(className _HelpAction extends Action {
...
const _VersionAction = _callable(className _VersionAction extends Action {
...
const _SubParsersAction = _camelcase_alias(_callable(className _SubParsersAction extends Action {
    ...
    constructor() {
        ...
        this._parser_className = parser_className
    ...
    add_parser() {
        ...
        let parser = new this._parser_className(kwargs)
...
_SubParsersAction.prototype._ChoicesPseudoAction = _callable(className _ChoicesPseudoAction extends Action {
...
const _ExtendAction = _callable(className _ExtendAction extends _AppendAction {
    call(parser, namespace, values/*, option_string = undefined*/) {
        let items = getattr(namespace, this.dest, undefined)
        items = _copy_items(items)
...
// Type classNamees
// ==============
const FileType = _callable(className FileType extends Function {
    /*
...
// ===========================
const Namespace = _callable(className Namespace extends _AttributeHolder() {
    /*
...
const _ActionsContainer = _camelcase_alias(_callable(className _ActionsContainer {
    ...
    add_argument() {
        ...
        let action_className = this._pop_action_className(kwargs)
        if (typeof action_className !== 'function') {
            throw new TypeError(sub('unknown action "%s"', action_className))
        }
        // eslint-disable-next-line new-cap
        let action = new action_className(kwargs)
        ...
        if (type_func === FileType) {
            throw new TypeError(sub('%r is a FileType className object, instance of it' +
    ...
    _pop_action_className(kwargs, default_value = undefined) {
...
const _ArgumentGroup = _callable(className _ArgumentGroup extends _ActionsContainer {
...
const _MutuallyExclusiveGroup = _callable(className _MutuallyExclusiveGroup extends _ArgumentGroup {
...
const ArgumentParser = _camelcase_alias(_callable(className ArgumentParser extends _AttributeHolder(_ActionsContainer) {
    /*
     ...
     *      - formatter_className -- HelpFormatter className for printing help messages
    ...
    constructor() {
        ...
        this.usage = usage
        this.epilog = epilog
        this.formatter_className = formatter_className
    ...
    add_subparsers() {
        ...
        // add the parser className to the arguments if it's not present
        setdefault(kwargs, 'parser_className', this.constructor)
        ...
        let parsers_className = this._pop_action_className(kwargs, 'parsers')
        // eslint-disable-next-line new-cap
        let action = new parsers_className(Object.assign({ option_strings: [] }, kwargs))
    ...
    _get_value(action, arg_string) {
        ...
        try {
            try {
                ...
                // Dear TC39, why would you ever consider making es6 classNamees not callable?
                // We had one universal interface, [[Call]], which worked for anything
                // (with familiar this-instanceof guard for classNamees). Now we have two.
                if (err instanceof TypeError &&
                    /className constructor .* cannot be invoked without 'new'/.test(err.message)) {
                    // eslint-disable-next-line new-cap
    ...
    _get_formatter() {
        // eslint-disable-next-line new-cap
        return new this.formatter_className({ prog: this.prog })
    }
    ...
    error(message) {
         ...
         *  exits.
         *
         *  If you override this in a subclassName, it should not return -- it
